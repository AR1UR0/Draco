...
<html lang="es">
  <head>
    ...
    <script defer src="{{ asset('js/preguntas/preguntasImagenes.js') }}"></script>
  ...
  <body>
    <div class="d-flex flex-column min-vh-100">
      ...
      <main
        class="container py-5 flex-grow-1 d-flex flex-column align-items-center">
        <h5 class="text-uppercase text-pink mb-3">Lee y responde</h5>
        <h2 id="preguntaTexto" class="question-text mb-5 text-center">
          ¿Señala quién es Frodo?
        </h2>

        <div id="opcionesContenedor" class="options-grid-images mt-5"></div>
      </main>
